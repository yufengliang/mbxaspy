...
for isk in range(pool.nsk):
    ...
    sticks = xmat_to_sticks_soc(iscf, ispin, ixyz_list_, nocc, offset = -fscf.e_lowest, evec = userin.EVEC)
    ...
    if userin.final_1p:
        sticks = xmat_to_sticks_soc(fscf, ispin, ixyz_list_, nocc, offset = -fscf.e_lowest, evec = userin.EVEC)
